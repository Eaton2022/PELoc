...
if __name__ == '__main__':
    ...
    expanded_h5_path = osp.join(
        r"D:\文件\code_learn\3D-Detection-Tracking-Viewer-master\3D-Detection-Tracking-Viewer-master\h5",
        "velodyne_left_False_init_t=0.5_bias=+2_3.4_q_6.17.h5"
    )
    ...
    point_cloud_pass_3 = osp.join(r"D:\文件\Oxford\txt\SPVNAS_velodyne_left_plane_segmented_5_L_6.9")  #### 3.4号增加旋转的影响
